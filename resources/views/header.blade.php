...
<head>
    ...
    <script type='text/javascript' src="{{asset('js/plugins/plupload/plupload.js')}}"></script>
    <script type='text/javascript' src="{{asset('js/plugins/plupload/plupload.gears.js')}}"></script>
    <script type='text/javascript' src="{{asset('js/plugins/plupload/plupload.silverlight.js')}}"></script>
    <script type='text/javascript' src="{{asset('js/plugins/plupload/plupload.flash.js')}}"></script>
    <script type='text/javascript' src="{{asset('js/plugins/plupload/plupload.browserplus.js')}}"></script>
    <script type='text/javascript' src="{{asset('js/plugins/plupload/plupload.html4.js')}}"></script>
    <script type='text/javascript' src="{{asset('js/plugins/plupload/plupload.html5.js')}}"></script>
    <script type='text/javascript' src="{{asset('js/plugins/plupload/jquery.plupload.queue/jquery.plupload.queue.js')}}"></script>
